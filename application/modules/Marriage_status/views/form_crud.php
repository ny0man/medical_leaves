			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						<div class="row" style="margin-bottom: 10px">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
								...
								$paramFormInput = array(
									'name'        => 'mrgStNama',
									'id'          => 'mrgStNama',
									'value'       => (isset($mrgStNama))?$mrgStNama:null,					
									'class'			=> 'form-control',
									'style'         => '',
									'placeholder'	=> 'misal : married, single'
								);
						...
						<div class="row" style="margin-bottom: 10px">
							<div class="col-lg-3 col-md-3 col-sm-3 col-xs-3">
								Marriage benefit bind
							</div>
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
								<?php
									$options = $list_benefit;
									$optionsSelected = (isset($mrgStBenefitId))?$mrgStBenefitId:null;
									$extra = array(
												'class' => 'form-control'
											);
									echo form_dropdown('mrgStBenefitId', $options, $optionsSelected,$extra);
								?>
							</div>
						</div>
