							...
							<?php foreach($data as $key => $value): ?>
								<tr>
									<td>
										...
										onclick="confirm_delete('<?= $value['mrgStNama'] ?>','<?= site_url($this->nama_controller.'/delete')?>','<?= $value[$this->primary_tabel] ?>')"></button>
									</td>                    
									<td><?= $value['mrgStNama'] ?></td>
									<td><?= $list_benefit[$value['mrgStBenefitId']] ?></td>
								</tr>
							<?php endforeach ?>
							</tbody>
						</table>
