							...
							<?php foreach($data as $key => $value): ?>
								<tr>
									<td>
										...
										onclick="confirm_delete('<?= $value['refMenuNama'] ?>','<?= site_url($this->nama_controller.'/delete')?>','<?= $value[$this->primary_tabel] ?>')"></button>
									</td>                    
									<td><?= $value['refMenuNama'] ?></td>
									<td><?= $value['refMenuInfo'] ?></td>
									<td><?= $value['refMenuUrutan'] ?></td>
									<td><i class="<?= $value['refMenuIcon'] ?>"></td> 
								</tr>
							<?php endforeach ?>
							</tbody>
						</table>
