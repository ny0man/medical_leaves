...
class Job_status extends MY_Controller {
	...
	var $nama_menu = 'Job status';
	var $nama_controller = 'Job_status';
	var $nama_tabel = 'job_status';
	var $primary_tabel = 'jobStatusId';
	...
	public function validasi_field(){
		...
		$this->form_validation->set_rules('jobStatusNama', 'Job status', 'required');
	...
	public function simpan(){
		...
		$db_result = 0;
		$parameter = array(
			'jobStatusNama' => $this->input->post('jobStatusNama')
		);
