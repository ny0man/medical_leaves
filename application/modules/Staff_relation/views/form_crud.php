					...
					<div class="box-body">
						<div class="row" style="margin-bottom: 10px">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
								...
								$paramFormInput = array(
									'name'        => 'staffRelNama',
									'id'          => 'staffRelNama',
									'value'       => (isset($staffRelNama))?$staffRelNama:null,					
									'class'			=> 'form-control',
									'style'         => '',
									'placeholder'	=> 'misal : spouse/child'
								);
						...
						<div class="row" style="margin-bottom: 10px">
							...
							<div class="col-lg-9 col-md-9 col-sm-9 col-xs-9">
								<?php 
								$paramFormInput = array(
									'name'        => 'staffRelEmpSubNo',
									'id'          => 'staffRelEmpSubNo',
									'value'       => (isset($staffRelEmpSubNo))?$staffRelEmpSubNo:null,					
									'class'			=> 'form-control',
									'style'         => '',
									'placeholder'	=> 'misal : spouse diisi angka 1, child 1 diisi angka 2'
								);
