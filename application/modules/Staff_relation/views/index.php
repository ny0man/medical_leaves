							...
							<?php foreach($data as $key => $value): ?>
								<tr>
									<td>
										...
										onclick="confirm_delete('<?= $value['staffRelNama'] ?>','<?= site_url($this->nama_controller.'/delete')?>','<?= $value[$this->primary_tabel] ?>')"></button>
									</td>                    
									<td><?= $value['staffRelNama'] ?></td>
									<td><?= $value['staffRelEmpSubNo'] ?></td> 
								</tr>
							<?php endforeach ?>
							</tbody>
						</table>
