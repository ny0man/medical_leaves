...
class Ref_controller extends MY_Controller {
	
	var $nama_menu = 'Ref Controller';
	var $nama_controller = 'Ref_controller';
	...
	public function validasi_field(){
		...
		$this->form_validation->set_rules('refControllerNama', 'Nama', 'required');
	...
	public function simpan(){
		...
		$db_result = 0;
		$parameter = array(
			'refControllerNama' => $this->input->post('refControllerNama') 
		);
