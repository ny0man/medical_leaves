							...
							<?php foreach($data as $key => $value): ?>
								<tr>
									<td>
										...
										onclick="confirm_delete('<?= $value['refUserNama'] ?>','<?= site_url($this->nama_controller.'/delete')?>','<?= $value[$this->primary_tabel] ?>')"></button>
									</td>                    
									<td><?= $value['refUserNama'] ?></td>
									<td><?= $value['refUserNamaAsli'] ?></td>
									<td><?= $list_group[$value['refGroupId']] ?></td> 
								</tr>
							<?php endforeach ?>
							</tbody>
						</table>
